    ...
    <div class="container">
                    ...
                    @foreach($tests as $test)
                        ...
                        <td>
                            @if($test->report == "Not Available")
                                {{$test->report}}
                            @else
                                <a href="{{route('onestop.download', ['id'=> $test->id])}}">Download</a>
                            @endif
                        </td>
        ...
        <div class="row">
            <div class="col text-right">
                <a class="btn btn-primary" href="{{route('onestop.finish', ['order_id' => $order_details->id, 'due'=> ($total-$order_details->payment)])}}">Confirm</a>
            </div>
        </div>
        @endif
